...
!!! abstract "Before you start"
    - **Prerequisites:** A complete detailed CESDM model ([multi-domain example](../examples/building-first-model/overview.md) or your own)
    - **You'll learn:** how to derive coarser models for studies that do not need nodal detail

!!! info "Reference model"
    Examples build upon the [multi-domain example](../examples/building-first-model/overview.md).
...
**Modeller scenario:** You built a nodal TYNDP-style model ([Convert TYNDP and PyPSA](../examples/import-tyndp-and-pypsa.md)), but your capacity expansion tool needs country-level regions. Spatial aggregation derives that coarser model without rebuilding from scratch.
...
→ [Convert TYNDP and PyPSA](../examples/import-tyndp-and-pypsa.md)
