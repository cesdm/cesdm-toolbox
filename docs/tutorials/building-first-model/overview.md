...
| [Part 1](part-1-system-and-network.md) | 1–4 | Schema, system container, electricity domain, regions, buses |
    | [Part 2](part-2-demand-and-generation.md) | 5–7 | Demand, time axis, library resources, generators |
| [Part 3](part-3-profiles-and-interconnectors.md) | 9–11 | Profiles, reservoir hydro, cross-border interconnectors |
...
| Script | API |
|--------|-----|
| `docs/examples/reference_energy_system_model_proxy_api.py` | Proxy API (compact, matches this tutorial) |
| `docs/examples/reference_energy_system_model_core_api.py` | Core EAR API (explicit `add_attribute` / `add_relation`) |
