...
One of the fundamental design goals of the [EAR](../reference/glossary.md#ear) engine is to allow schemas to evolve without modifying existing schema packages.

Rather than maintaining a single monolithic schema, the [EAR](../reference/glossary.md#ear) engine composes multiple independent schema packages into a single semantic model at load time.
...
Instead, [EAR](../reference/glossary.md#ear) allows existing [entity classes](../reference/glossary.md#entity-class) to be **augmented** with additional semantic concepts while preserving their original identity.
...
Extensions may define completely new [entity classes](../reference/glossary.md#entity-class).
...
Extensions may attach additional attributes and relations to existing [entity classes](../reference/glossary.md#entity-class).

Unlike inheritance, augmentation does **not** create a new [entity class](../reference/glossary.md#entity-class).
...
Augmentations may introduce new [Attribute Groups](../reference/glossary.md#attribute-group).
...
The generated [Proxy API](../reference/glossary.md#proxy-api) therefore exposes
...
The augmentation therefore integrates seamlessly with the existing [Proxy API](../reference/glossary.md#proxy-api).
...
The [EAR](../reference/glossary.md#ear) engine composes:

- [entity classes](../reference/glossary.md#entity-class);
...
Before the composed schema becomes available, the [EAR](../reference/glossary.md#ear) engine validates:
...
Schema augmentation is fully reflected in the generated [Proxy API](../reference/glossary.md#proxy-api) and Python typings.
...
the new [Attribute Group](../reference/glossary.md#attribute-group) becomes part of the generated API.
