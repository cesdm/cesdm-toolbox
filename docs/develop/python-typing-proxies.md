...
!!! info "Optional — skip until you use the [Proxy API](../reference/glossary.md#proxy-api) daily"
    Energy system modellers can ignore this page initially. It documents IDE autocomplete and static type checking for the [Python API](python-api.md). Start with [Build models](../use/build-models.md) instead.

CESDM provides schema-aware Python typing for the object-oriented [Proxy API](../reference/glossary.md#proxy-api).
...
The Core [EAR](../reference/glossary.md#ear) API is intentionally generic:
...
- which [Attribute Group](../reference/glossary.md#attribute-group) contains an attribute;
- which value type is expected;
- which [entity classes](../reference/glossary.md#entity-class) are valid relation targets.

The [Proxy API](../reference/glossary.md#proxy-api) exposes this information through typed Python objects:
...
Static typing does not replace [schema validation](../reference/glossary.md#schema-validation).
...
CESDM generates one proxy subclass for each schema [entity class](../reference/glossary.md#entity-class).
...
However, a static type checker cannot infer the [entity class](../reference/glossary.md#entity-class) from an arbitrary string identifier. The static return type is therefore the generic `EntityProxy`.
...
[Attribute Groups](../reference/glossary.md#attribute-group) are reflected in the generated type stubs.
...
A group may exist globally but not be supported by every [entity class](../reference/glossary.md#entity-class).
...
Not every field belongs to an [Attribute Group](../reference/glossary.md#attribute-group).
...
Reading a relation through the CESDM [Proxy API](../reference/glossary.md#proxy-api) returns wrapped proxy objects rather than plain strings.
...
The runtime [Proxy API](../reference/glossary.md#proxy-api) provides schema-aware typo detection.
...
Static typing verifies the broad Python type; [schema validation](../reference/glossary.md#schema-validation) verifies the full semantic constraint.
...
- CESDM [YAML](../reference/glossary.md#yaml) schemas;
- schema inheritance;
- attributes and relations;
- [Attribute Groups](../reference/glossary.md#attribute-group);
- public `CesdmModel` and [EAR](../reference/glossary.md#ear) method signatures;
- known [Default Library](../reference/glossary.md#default-library) [entity classes](../reference/glossary.md#entity-class).
...
The generator covers the public API of `CesdmModel`, including inherited [EAR](../reference/glossary.md#ear) operations and CESDM mixins.
...
After changing [entity classes](../reference/glossary.md#entity-class) or schema inheritance, run:
...
Python union types can be used when a function supports several [entity classes](../reference/glossary.md#entity-class).
...
Use the Core [EAR](../reference/glossary.md#ear) API for schema-independent tooling:
...
- [entity classes](../reference/glossary.md#entity-class) and inheritance;
- attributes and relations;
- [Attribute Groups](../reference/glossary.md#attribute-group);
- relation targets;
...
Together, the Core [EAR](../reference/glossary.md#ear) API, [Proxy API](../reference/glossary.md#proxy-api), generated typings, [schema validation](../reference/glossary.md#schema-validation), and analysis-specific validation provide complementary layers for building reliable CESDM applications.
