...
!!! abstract "Before you start"
    - **Prerequisites:** [Entities and relationships](entities-and-relationships.md)
    - **Electricity-only first model:** [Build your first model](../get-started/first-model.md)
    - **Multi-carrier example:** [Conversion units](../examples/conversion-units/overview.md)
...
Your [first model](../get-started/first-model.md) uses one electricity domain. For the minimal pattern, see that tutorial — this page focuses on **multi-carrier scope and modelling boundaries**.
...
For a worked district-hub example with heat pump, electrolyser, boiler, fuel cell, and CHP, see the [conversion units example](../examples/conversion-units/overview.md).
...
→ [Related work](related-work.md) · [Conversion units](../examples/conversion-units/overview.md)
