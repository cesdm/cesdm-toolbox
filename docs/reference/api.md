...
!!! warning "Energy system modellers — start elsewhere"
    For day-to-day model building, use **`cesdm_toolbox`** and the [Proxy API guide](../develop/python-api.md).

    To look up classes, attributes, and relations, open the **[CESDM Schema Reference](schema-reference.html)** (interactive HTML) or [Build models](../use/build-models.md).
