...
!!! info "Checkpoint"
    After Part 4 you should have a validated model exported to [YAML](../../reference/glossary.md#yaml) and [Frictionless Data Package](../../reference/glossary.md#frictionless-data-package) format.

## 12. Extend the system with gas and heat

Add carriers, [Carrier Domains](../../reference/glossary.md#carrier-domain), and buses with the [Proxy API](../../reference/glossary.md#proxy-api):
...
| Operation | [Proxy API](../../reference/glossary.md#proxy-api) (this tutorial) | Core [EAR](../../reference/glossary.md#ear) API |
|---|---|---|
...
The [Proxy API](../../reference/glossary.md#proxy-api) provides:
...
- regions and [Carrier Domains](../../reference/glossary.md#carrier-domain);
...
See the [Proxy API guide](../../develop/python-api.md) for patterns beyond this reference model. Then explore [Libraries](../../understand/libraries.md) and [Profiles](../../understand/profiles.md) as you extend your own study models.
...
→ Next: [Conversion Units](../conversion-units/overview.md)
