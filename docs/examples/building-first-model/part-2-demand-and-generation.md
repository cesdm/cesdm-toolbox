...
!!! info "Checkpoint"
    After Part 2 you should have demand units, a `[TimestampSeries](../../reference/glossary.md#timestamp-series)`, library resources, and at least one `GenerationUnit`.
...
A `[TimestampSeries](../../reference/glossary.md#timestamp-series)` is also an ordinary CESDM entity:
...
The imported [Default Library](../../reference/glossary.md#default-library) already contains reusable resource entities such as:
...
The physical generator contains its asset-specific information. The reusable technology entity from the [Default Library](../../reference/glossary.md#default-library) contains shared technology data such as dispatch classification, efficiency, costs, and carrier relations. The system model references that library entity instead of duplicating its content.
