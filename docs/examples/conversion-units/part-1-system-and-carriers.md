...
Cross-domain conversion never merges these domains — each keeps its own balance. Conversion units are the only semantic bridge ([Carrier Domains](../../understand/carrier-domains.md)).
...
← Previous: [Conversion Units](overview.md)  
