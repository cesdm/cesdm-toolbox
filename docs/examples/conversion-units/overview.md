...
!!! abstract "Before you start"
    - **Prerequisites:** [Build your first model](../../get-started/first-model.md), [Carrier domains](../../understand/carrier-domains.md), [Libraries](../../understand/libraries.md)
    - **Time:** ~30–40 minutes across four parts
    - **Audience:** modellers coupling electricity, gas, heat, and hydrogen

This tutorial builds a **Swiss district energy hub** that links four carrier domains through the compact [`ConversionUnit`](../../reference/glossary.md#conversion-unit) leaves:
...
→ Next: [Part 1 — System and Carriers](part-1-system-and-carriers.md)
