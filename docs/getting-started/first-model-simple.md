...
Inspect `output/minimal_electricity_model/demo_2030.yaml` and the `frictionless/` folder.
...
### 2 — Core EAR API: system and electricity domain

Use the three core operations explicitly once — this is what every CESDM model uses under the hood:
