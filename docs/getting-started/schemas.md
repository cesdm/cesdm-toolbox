...
!!! abstract "Before you start"
    ...
    - **Lookup only:** [CESDM Schema Reference](../reference/schema-reference.md) or [Modeller cheat sheet](modeller-cheat-sheet.md)
...
| `planning` | Planning and investment information |
