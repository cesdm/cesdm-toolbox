...
!!! quote ""
    ...
    **Why CESDM?** One system description — shared data, comparable results.
...
[EAR API Reference](reference/api-reference.md){ .md-button }
...
| **Audience** | Energy system modellers, data engineers, and tool integrators |
...
| :material-book-open-page-variant: **Reference** | Lookup schemas and API | [CESDM Schema Reference](reference/schema-reference.md) · [EAR API Reference](reference/api-reference.md) |
