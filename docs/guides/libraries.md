...
After importing the library, the predefined entities become available for reuse throughout the model. 

---

# Example: A Technology Definition

The following example shows the library entry for the predefined combined-cycle gas turbine technology **`Generation.Thermal.Gas.CCGT.Present2`**.

```yaml
Generation.Thermal.Gas.CCGT.Present2:
  attributes:
    - id: name
      value: Generation.Thermal.Gas.CCGT.Present2
    - id: dispatch_type
      value: dispatchable
