...
Thanks for your interest in the Common Energy System Domain Model. This first release establishes a solid and usable foundation for CESDM, while leaving room for further extensions, new use cases and contributions from the community. Feedback, issues and contributions from the energy-system modelling community are genuinely welcome.
