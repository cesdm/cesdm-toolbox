...
class CHPUnitPlanningProxy(FlatGroupViewProxy):
...
class CHPUnitSpatialProxy(FlatGroupViewProxy):
    latitude: float | None
...
class ConversionUnitDispatchProxy(FlatGroupViewProxy):
...
class ConversionUnitPlanningProxy(FlatGroupViewProxy):
    commissioning_year: int | None
    commission_date: datetime | None
    retrofit_date: datetime | None
    retirement_date: datetime | None

class ConversionUnitSpatialProxy(FlatGroupViewProxy):
    latitude: float | None
    longitude: float | None
    elevation: float | None
    @property
...
class DemandUnitPlanningProxy(FlatGroupViewProxy):
    commissioning_year: int | None
    commission_date: datetime | None
    retrofit_date: datetime | None
    retirement_date: datetime | None
...
class DemandUnitSpatialProxy(FlatGroupViewProxy):
    latitude: float | None
    longitude: float | None
    elevation: float | None
    @property
...
class ExternalSupplyPlanningProxy(FlatGroupViewProxy):
    commissioning_year: int | None
    commission_date: datetime | None
    retrofit_date: datetime | None
    retirement_date: datetime | None

class ExternalSupplySpatialProxy(FlatGroupViewProxy):
    latitude: float | None
    longitude: float | None
    elevation: float | None
    @property
...
class GenerationUnitPlanningProxy(FlatGroupViewProxy):
    commissioning_year: int | None
    commission_date: datetime | None
    retrofit_date: datetime | None
    retirement_date: datetime | None
...
class GenerationUnitSpatialProxy(FlatGroupViewProxy):
    latitude: float | None
    longitude: float | None
    elevation: float | None
    @property
...
class HVDCLinkPlanningProxy(FlatGroupViewProxy):
    commissioning_year: int | None
    commission_date: datetime | None
    retrofit_date: datetime | None
    retirement_date: datetime | None
...
class HydroGenerationUnitPlanningProxy(FlatGroupViewProxy):
    commissioning_year: int | None
    commission_date: datetime | None
    retrofit_date: datetime | None
    retirement_date: datetime | None
...
class HydroGenerationUnitSpatialProxy(FlatGroupViewProxy):
    latitude: float | None
    longitude: float | None
    elevation: float | None
    @property
...
class InterconnectorPlanningProxy(FlatGroupViewProxy):
    commissioning_year: int | None
    commission_date: datetime | None
    retrofit_date: datetime | None
    retirement_date: datetime | None

class InterconnectorPowerFlowProxy(FlatGroupViewProxy):
    maximum_power_flow_from_to: float | None
    maximum_power_flow_to_from: float | None

class InterconnectorSpatialProxy(FlatGroupViewProxy):
    latitude: float | None
    longitude: float | None
    elevation: float | None
    @property
...
class InterconnectorTopologyProxy(FlatGroupViewProxy):
    from_switch_closed: bool | None
    to_switch_closed: bool | None
    @property
    def fromNode(self) -> NetworkNodeProxy | None: ...
...
class ReservoirStorageUnitDispatchProxy(FlatGroupViewProxy):
...
class ReservoirStorageUnitPlanningProxy(FlatGroupViewProxy):
    commissioning_year: int | None
    commission_date: datetime | None
    retrofit_date: datetime | None
    retirement_date: datetime | None

class ReservoirStorageUnitSpatialProxy(FlatGroupViewProxy):
    latitude: float | None
    longitude: float | None
    elevation: float | None
    @property
...
class ShuntUnitPlanningProxy(FlatGroupViewProxy):
    commissioning_year: int | None
    commission_date: datetime | None
    retrofit_date: datetime | None
    retirement_date: datetime | None
...
class ShuntUnitSpatialProxy(FlatGroupViewProxy):
    latitude: float | None
    longitude: float | None
    elevation: float | None
    @property
...
class SolarGenerationUnitPlanningProxy(FlatGroupViewProxy):
    commissioning_year: int | None
    commission_date: datetime | None
    retrofit_date: datetime | None
    retirement_date: datetime | None
...
class SolarGenerationUnitSpatialProxy(FlatGroupViewProxy):
    latitude: float | None
    longitude: float | None
    elevation: float | None
    @property
...
class StorageUnitPlanningProxy(FlatGroupViewProxy):
    commissioning_year: int | None
    commission_date: datetime | None
    retrofit_date: datetime | None
    retirement_date: datetime | None

class StorageUnitSpatialProxy(FlatGroupViewProxy):
    latitude: float | None
    longitude: float | None
    elevation: float | None
    @property
...
class ThermalGenerationUnitPlanningProxy(FlatGroupViewProxy):
    commissioning_year: int | None
    commission_date: datetime | None
    retrofit_date: datetime | None
    retirement_date: datetime | None
...
class ThermalGenerationUnitSpatialProxy(FlatGroupViewProxy):
    latitude: float | None
    longitude: float | None
    elevation: float | None
    @property
...
class TransformerPlanningProxy(FlatGroupViewProxy):
    commissioning_year: int | None
    commission_date: datetime | None
    retrofit_date: datetime | None
    retirement_date: datetime | None
...
class TransformerSpatialProxy(FlatGroupViewProxy):
    latitude: float | None
    longitude: float | None
    elevation: float | None
    @property
...
class TransmissionLinePlanningProxy(FlatGroupViewProxy):
    commissioning_year: int | None
    commission_date: datetime | None
    retrofit_date: datetime | None
    retirement_date: datetime | None
...
class TransmissionLineSpatialProxy(FlatGroupViewProxy):
    latitude: float | None
    longitude: float | None
    elevation: float | None
    @property
...
class WindGenerationUnitPlanningProxy(FlatGroupViewProxy):
    commissioning_year: int | None
    commission_date: datetime | None
    retrofit_date: datetime | None
    retirement_date: datetime | None
...
class WindGenerationUnitSpatialProxy(FlatGroupViewProxy):
    latitude: float | None
    longitude: float | None
    elevation: float | None
    @property
...
class CHPUnitProxy(EntityProxy):
    ...
    planning: CHPUnitPlanningProxy
    spatial: CHPUnitSpatialProxy
    ...
    nominal_electrical_power_capacity: float | None
    """Maximum electrical power output of a CHP unit. Unit: MW."""
    nominal_thermal_power_capacity: float | None
    """Maximum useful heat output of a CHP unit. Unit: MW."""
    electrical_efficiency: float | None
    """Ratio of electrical energy output to fuel energy input for a CHP unit. Unit: fraction."""
    thermal_efficiency: float | None
    """Ratio of useful heat output to fuel energy input for a CHP unit. Unit: fraction."""
    total_efficiency: float | None
    """Combined useful electrical and thermal output divided by fuel energy input. Unit: fraction."""
    power_to_heat_ratio: float | None
    """Ratio of electrical output to useful heat output of a CHP unit. Unit: fraction."""
    minimum_load: float | None
...
class CompositeAssetProxy(EntityProxy):
    name: str | None
    """Descriptive name."""
    long_name: str | None
    """Long description"""
...
class ConversionPortProxy(EntityProxy):
    ...
    """Maximum output power or output flow capacity of this ConversionPort. This attribute is intended for ports with port_direction = output or bidirectional. It represents the carrier-specific output limit at the port level, e.g. maximum electrical output of an electricity port or maximum thermal output of a heat port. The attribute belongs to ConversionPort rather than ConversionUnit because different output ports of the same ConversionUnit can have different capacities and carrier domains."""
    @property
...
class ConversionUnitProxy(EntityProxy):
    dispatch: ConversionUnitDispatchProxy
    planning: ConversionUnitPlanningProxy
    spatial: ConversionUnitSpatialProxy
    name: str | None
    """Descriptive name."""
    long_name: str | None
    """Long description"""
...
class DemandUnitProxy(EntityProxy):
    ...
    planning: DemandUnitPlanningProxy
    power_flow: DemandUnitPowerFlowProxy
    spatial: DemandUnitSpatialProxy
...
class ExternalSupplyProxy(EntityProxy):
    ...
    planning: ExternalSupplyPlanningProxy
    spatial: ExternalSupplySpatialProxy
...
class GenerationUnitProxy(EntityProxy):
    ...
    planning: GenerationUnitPlanningProxy
    power_flow: GenerationUnitPowerFlowProxy
    spatial: GenerationUnitSpatialProxy
...
class GeneratorDynamicResultProxy(EntityProxy):
    name: str | None
    """Descriptive name."""
    long_name: str | None
    """Long description"""
...
class HVDCLinkProxy(EntityProxy):
    ...
    planning: HVDCLinkPlanningProxy
    power_flow: HVDCLinkPowerFlowProxy
    spatial: HVDCLinkSpatialProxy
...
class HydroGenerationUnitProxy(EntityProxy):
    ...
    planning: HydroGenerationUnitPlanningProxy
    power_flow: HydroGenerationUnitPowerFlowProxy
    spatial: HydroGenerationUnitSpatialProxy
    ...
    """Whether this HydroGenerationUnit can also operate as a pump (pumped-hydro storage). true = PHS reversible machine; the unit can both generate electricity (turbine mode) and consume electricity to pump water to the upper reservoir (pump mode). false = pure turbine, generation only. Operational pumping parameters (charging_efficiency, maximum_charging_power, has_active_charging) belong on the linked ReservoirStorageUnit entity itself, not here."""
    machine_role: str | None
    ...
    def hasPowerSystemStabilizer(self, value: ControllerPSSProxy | str) -> None: ...
    @property
    def drawsFromReservoir(self) -> list[ReservoirStorageUnitProxy] | None: ...
    @drawsFromReservoir.setter
    def drawsFromReservoir(self, value: Iterable[ReservoirStorageUnitProxy | str]) -> None: ...
    @property
...
class InterconnectorProxy(EntityProxy):
    planning: InterconnectorPlanningProxy
    power_flow: InterconnectorPowerFlowProxy
    spatial: InterconnectorSpatialProxy
    topology: InterconnectorTopologyProxy
    name: str | None
    """Descriptive name."""
    long_name: str | None
    """Long description"""
...
class ReservoirStorageUnitProxy(EntityProxy):
    dispatch: ReservoirStorageUnitDispatchProxy
    planning: ReservoirStorageUnitPlanningProxy
    spatial: ReservoirStorageUnitSpatialProxy
    name: str | None
    """Descriptive name."""
    long_name: str | None
    """Long description"""
...
class ShuntUnitProxy(EntityProxy):
    planning: ShuntUnitPlanningProxy
    power_flow: ShuntUnitPowerFlowProxy
    spatial: ShuntUnitSpatialProxy
...
class SolarGenerationUnitProxy(EntityProxy):
    ...
    planning: SolarGenerationUnitPlanningProxy
    power_flow: SolarGenerationUnitPowerFlowProxy
    spatial: SolarGenerationUnitSpatialProxy
...
class StorageTypeProxy(EntityProxy):
    ...
    """Indicates whether this storage technology type receives a natural inflow of the stored carrier from an external source (e.g. rainfall into a reservoir, river inflow into a pumped-hydro open-loop system). When true, the same ReservoirStorageUnit entity should also carry an annual_natural_inflow_energy and natural_inflow_profile_reference. Mutually exclusive storage technologies (batteries, closed-loop pumped hydro) set this to false."""
...
class StorageUnitProxy(EntityProxy):
    ...
    planning: StorageUnitPlanningProxy
    spatial: StorageUnitSpatialProxy
...
class ThermalGenerationUnitProxy(EntityProxy):
    ...
    planning: ThermalGenerationUnitPlanningProxy
    power_flow: ThermalGenerationUnitPowerFlowProxy
    spatial: ThermalGenerationUnitSpatialProxy
...
class TransformerProxy(EntityProxy):
    planning: TransformerPlanningProxy
    power_flow: TransformerPowerFlowProxy
    spatial: TransformerSpatialProxy
...
class TransmissionLineProxy(EntityProxy):
    planning: TransmissionLinePlanningProxy
    power_flow: TransmissionLinePowerFlowProxy
    spatial: TransmissionLineSpatialProxy
...
class WaterBusProxy(EntityProxy):
    name: str | None
    """Descriptive name."""
    long_name: str | None
    """Long description"""
...
class WindGenerationUnitProxy(EntityProxy):
    ...
    planning: WindGenerationUnitPlanningProxy
    power_flow: WindGenerationUnitPowerFlowProxy
    spatial: WindGenerationUnitSpatialProxy
