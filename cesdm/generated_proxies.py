...
class CHPUnitProxy(EnergyAssetInstanceProxy):
...
class GeneratorDynamicResultProxy(DynamicResultProxy):
    """Proxy for CESDM entity class ``Generator.DynamicResult``."""
    pass
...
class ReservoirStorageUnitProxy(EnergyAssetInstanceProxy):
