...
class DiscoveryMixin:
    ...
    def validate_relation_targets(self) -> list:
        ...
        Example error::
            ...
            [GenerationUnit.DispatchResult] representsAsset.target 'GenerationUnitXXX'
    ...
    def _build_view_index(self) -> Dict[str, Dict[str, Dict]]:
        ...
        Walks every class that uses the representsAsset
        pattern -- Result entities (GenerationUnit.DispatchResult, etc.) --
        finds the representsAsset relation on each, and indexes it under
