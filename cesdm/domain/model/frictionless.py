    ...
    def export_frictionless(
        ...
        *,
        ...
        - Every relation becomes a real ``foreignKeys`` entry, including
          ...
          (mirroring the ``AllAssets`` pattern already used for the
...
#
#   resources/
#       BaseEntities/     ← Carrier, CarrierDomain, GeographicalRegion, …
...
#
        ...
        # AllAssets solves this for the EnergyAssetInstance hierarchy
        ...
        # HydrogenBus/WaterBus), Controller.AVR/.GOV/.PSS (each with
