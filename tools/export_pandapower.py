...
def export_pandapower_net(
    ...
    *,
    ...
    # Slack / external grid. The power-flow bus type lives directly on
    # the generation asset, not the bus, so identify slack buses through
    # connected generator assets rather than ElectricalBus itself.
