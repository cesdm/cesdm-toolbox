...
>
> For a Scenario-Assumptions-style HTML dashboard from the same YAML,
> use `tools/cesdm_assumptions_dashboard.py` (CLI: `cesdm-assumptions-dashboard --serve`
> and the **Load YAML** button, or `--yaml path` to write a standalone HTML file).
