...
def _add_gas_generator(model, gen_id):
    ...
    gen.hasTechnology = "Generation.Thermal.Gas.CCGT.Present2"
    gen.atNode = "bus.1"
    return gen
...
def test_cascade_returns_none_without_library_loaded():
    ...
    model.set_technology("gen.cascade.3", "Generation.Thermal.Gas.CCGT.Present2", technology_class="GeneratorType")
