...
def _model_with_bus():
    ...
    model.add_relation("bus.1", "locatedIn", "nuts3.ch021")
    return model, "bus.1"
...
def test_bus_powerflow_and_spatial_attributes_actually_land():
    ...
    model.add_relation("bus.new", "locatedIn", "region.test")
...
def test_total_capacity_finds_flattened_generation_units():
    ...
    searched for a separate dispatch view via representsAsset. Fixed
