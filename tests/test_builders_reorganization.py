...
def test_moved_query_functions_still_work_from_accessors():
    ...
    model.add_entity("ReservoirStorageUnit", "reservoir.1")
    model.add_relation("hydro.1", "drawsFromReservoir", "reservoir.1")
...
def test_reservoir_hydro_query_helpers_still_work_from_accessors():
    ...
    model.add_relation("gen.hydro.1", "drawsFromReservoir", "reservoir.1")
