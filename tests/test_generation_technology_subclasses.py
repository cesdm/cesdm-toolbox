...
def test_generation_unit_base_class_no_longer_carries_technology_specific_attributes():
    ...
    moved_out = {
        ...
        "machine_role", "turbine_efficiency", "maximum_pumping_power", "pumping_efficiency",
...
def test_hydro_specific_dispatch_attributes_live_on_hydro_generation_unit():
    ...
    model.add_attribute("hydro.1", "machine_role", "reversible")
    ...
    try:
        model.add_attribute("gen.plain", "machine_role", "turbine")
        assert False, "machine_role should not be settable on plain GenerationUnit"
    except KeyError:
        pass
