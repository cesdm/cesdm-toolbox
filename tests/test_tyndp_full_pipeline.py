...
def test_prune_removes_reservoirs_without_inflow():
    ...
    model.add_entity("ReservoirStorageUnit", "tech.reservoir.nodry")
    ...
    model.add_relation("gen.hydro.tech.reservoir.nodry", "drawsFromReservoir", "tech.reservoir.nodry")
    gen1 = model.get_entity("gen.hydro.tech.reservoir.nodry")
    gen1.dispatch.machine_role = "turbine"
    gen1.dispatch.nominal_power_capacity = 100

    # PHS reservoir with no natural inflow -- should be KEPT.
    model.add_entity("ReservoirStorageUnit", "tech.pump_storage_closed_loop.keep")
    ...
    model.add_relation("gen.phs.tech.pump_storage_closed_loop.keep", "drawsFromReservoir",
                       "tech.pump_storage_closed_loop.keep")
    gen2 = model.get_entity("gen.phs.tech.pump_storage_closed_loop.keep")
    gen2.dispatch.machine_role = "reversible"
