...
line.power_flow.series_resistance_per_km = pu_to_ohm(r_pu, Z_base_sys)
line.power_flow.series_reactance_per_km = pu_to_ohm(x_pu, Z_base_sys)
line.power_flow.shunt_susceptance_per_km = pu_to_siemens(b_pu, Z_base_sys)
```
