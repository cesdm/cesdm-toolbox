...
def build_two_bus_cesdm_case(schema_dir: Path):
    ...
    model.ensure_entity(class_name="GeographicalRegion", entity_id="region.demo", name="Demo region")
    ...
    model.add_relation("bus.1", "locatedIn", "region.demo")
    ...
    model.add_relation("bus.2", "locatedIn", "region.demo")
